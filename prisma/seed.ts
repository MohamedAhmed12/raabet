...
async function main() {
  ...
  const link = await prisma.link.create({
    data: {
      ...
      general_styles_desktop_bgcolor: '{"r":241,"g":241,"b":241,"a":1}',
      general_styles_primary_text_color: '{"r":22,"g":21,"b":21,"a":1}',
      general_styles_primary_bgcolor: '{"r":255,"g":255,"b":255,"a":1}',
      general_styles_is_secondary_bgcolor: false,
      general_styles_is_label_exist: false,
      general_styles_secondary_bgcolor: '{"r":22,"g":21,"b":21,"a":1}',
      ...
      header_styles_profile_border_color: '{"r":37,"g":37,"b":61,"a":1}',
      header_styles_collapse_long_bio: true,
      header_styles_social_icons_size: 0.1,
      header_styles_text_spacing: 0,
      card_styles_design: 2,
      card_styles_card_color: '{"r":241,"g":241,"b":241,"a":1}',
      card_styles_text_color: '{"r":22,"g":21,"b":21,"a":1}',
      card_styles_label_color: '{"r":241,"g":241,"b":241,"a":1}',
      card_styles_card_corner: 0,
      card_styles_card_border_width: 0.1,
      card_styles_card_border_color: '{"r":37,"g":37,"b":61,"a":1}',
